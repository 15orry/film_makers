    ...
    data : () => {
        return {
            movieList : [
                ...
                {img: "cont_02.jpeg", title: "소공녀 (Microhabitat, 202)"},
            ...
            <div class="wrap">
                ...
                <div class="content">
                    ...
                    <div v-for="list in movieList" class="box">
                        ...
                        <h3>죄 많은 소녀(After My Death, 2019)</h3>
                    </div>
                </div>
            </div>
        </div>   
        ...
        <div class="banner_middle">
            <div class="wrap">
                <div class="txt_part">
                    ...
                    <p>실시간으로 업데이트 되는 오디션 정보를 확인 하실 수 있습니다. <br>배우 또는 배우 지망생분들의 참여 바랍니다.</p>
                    <a href="">오디션 정보확인</a>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="wrap">
            ...
            <div class="footer_info">
                ...
                <div class="box">
                    <p>고객센터(이용 및 결제 문의) 제휴 및 대외협력, 광고 문의</p>
                    <ul>
